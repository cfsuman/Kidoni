...
public class CountryActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the activity
        mActivity = CountryActivity.this;
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.LOLLIPOP){
            ...
            TransitionManager.beginDelayedTransition(mCLayout,explode);
        }
        // Specify the RecyclerView adapter
        mAdapter = new SimpleTextBaseAdapter(mContext,mList);

        // Data bind the recycler view with adapter data
