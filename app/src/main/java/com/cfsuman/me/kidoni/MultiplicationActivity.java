...
public class MultiplicationActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = MultiplicationActivity.this;
        ...
        mButtonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //-------------------------------------------------------------------------------------------- change 2
                Question question = QuestionManager.generateMultiplicationQuestion(16,5);
                ...
                //-------------------------------------------------------------------------------------------- change 4
                mTextToSpeak = question.getNum1()+" multiply by "+question.getNum2();
